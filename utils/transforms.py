...
class Transformer:
    """Apply the following transformation to image and it mask : [brightness, contrast, gamma, saturation, HFlip, Cropping, Rotation, Shearing]."""

    def __init__(self, brightness_range=(1,1), contrast_range=(1,1), gamma_range=(1,1), saturation_range=(1,1), hflip=False, crop=False, rotate=0, shear=0):
